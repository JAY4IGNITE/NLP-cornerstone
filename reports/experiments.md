...
Comparing feature representations and classifiers on 20,944 training samples across 23 intents.

| Architecture | Accuracy (%) | Macro F1 (%) | Weighted F1 (%) | Training Time (s) |
| :--- | :--- | :--- | :--- | :--- |
| TF-IDF + Logistic Regression (C=2.5) | 100.0% | 100.0% | 100.0% | 2.38s |
| TF-IDF + Multinomial Naive Bayes | 99.89% | 99.89% | 99.89% | 0.05s |
| TF-IDF + Linear Support Vector Machine | 100.0% | 100.0% | 100.0% | 1.81s |
